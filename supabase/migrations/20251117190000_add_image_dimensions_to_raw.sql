-- Add image dimensions to raw.recognition_files
ALTER TABLE raw.recognition_files 
  ADD COLUMN IF NOT EXISTS image1_width INTEGER,
  ADD COLUMN IF NOT EXISTS image1_height INTEGER,
  ADD COLUMN IF NOT EXISTS image2_width INTEGER,
  ADD COLUMN IF NOT EXISTS image2_height INTEGER;

-- Update transform function to use actual dimensions from raw table
