-- Migration: Add RPC function for efficient filtered work logs retrieval
-- Description: Returns latest work_log for each recognition with filtering support
...
COMMENT ON FUNCTION get_filtered_work_logs IS 
  'Returns latest completed work_log for each recognition with multi-stage filtering support. Optimized for export preview API.';
