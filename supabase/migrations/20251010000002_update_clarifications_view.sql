-- Update clarifications_with_bucket view to include correct_dishes and actual_correct_ean
BEGIN;
...
COMMENT ON VIEW public.clarifications_with_bucket IS 'Clarifications with orders, states, frequency bucket, and correct dishes for API consumption.';
