...
Профессиональная система аннотирования заказов ресторанов с валидацией блюд, баззеров и объектов.
...
3. `validate_buzzers` - валидация баззеров
4. `check_buzzer_positions` - позиции баззеров
...
3. Выполнить текущий этап:
   ...
   - **validate_buzzers**: Нарисовать и классифицировать баззеры
